...
... however the form of $E_{xc}[n]$ is unknown
Below the Kohn-Sham equations are outlined ... KS orbitals ... solved self-consistently ...
(see Prasad Ch3)

\cite{RichardMartin_Ch6}
\cite{Prasad_ch3}



** See comp QM L8 + Prasad ch3 **
...
LDA (good for metals)
As simple as the Hartree theory, but gives much better results than H-F theory due to the inclusion of both exchange and correlation fairly accurately (whereas the H-F theory includes exchange exactly but neglects correlation completely) \cite{Prasad_ch3}.
