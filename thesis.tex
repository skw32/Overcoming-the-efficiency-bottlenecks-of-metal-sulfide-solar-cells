...
The methodology outline here is used in the study presented in section \ref{sulfosalt_band_alignment}.

\subsection{**Absolute electron energies and surface models}
Outline slab models, vacuum ref level, etc.? Refer back to Fig. \ref{slab_PBCs}.
