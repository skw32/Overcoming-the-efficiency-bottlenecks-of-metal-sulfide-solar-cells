...
Leave all subsequent sections as further work if not complete before December submission? + mention collaborative benchmark study to compare defect formation energy of a charged V-Ga in GaAs with the supercell method and FNV finite-size corrections to the formation energy of the defect embedded in a large, aperiodic cluster? (test the validity of the finite-size correction scheme utilised above)\\ 
