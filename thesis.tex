...
In this section, analysis that could be performed on the complete datasets from Tables \ref{enargite_neutral_Ef} and \ref{enargite_charged_Ef} is discussed. In the final section of this chapter recent literature on the impact of defect physics on the performance of PV materials and defect tolerance studies are discussed. The chapter ends with some hypotheses which could be tested with a complete dataset from this case study.\\
