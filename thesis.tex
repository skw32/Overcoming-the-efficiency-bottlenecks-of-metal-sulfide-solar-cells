...
Mention that layers for solar cell (except for absorber layer) are not labelled since exact architecture varies for different PV technologies
Optical excitation of electron-hole pair in absorber layer indicated in green box 
...
\begin{figure}[h!]
  \centering
    \includegraphics[width=0.85\textwidth]{figures/new_p-n_schematic.png}
