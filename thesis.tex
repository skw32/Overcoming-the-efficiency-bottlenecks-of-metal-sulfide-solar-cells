...
\begin{figure}[h!]
  \centering
    ...
    \caption[Ionisation levels of intrinsic point defects in the band gaps of {\CZTS}]{Ionisation levels of intrinsic point defects in the band gaps of {\CZTS}. Taken from Ref. \citenum{defects_Chen}.}
  \label{defects_CZTS}
\end{figure}
...
** Defect concentration maps wrt fermi energy (use sc-fermi? or work with Stephan/ Jie?) **\\
