...
However, at this stage it is unclear if these novel materials will provide new pathways to high-performance or result in added complexity in solar cell fabrication, such as depolarisation fields at device interfaces \cite{FE-PV_kirchartz} or if static ferroelectric domains could act as internal diodes and hinder charge-carrier transport. Building a theoretical framework to model and gain insights into such systems would be very challenging. The aim of \autoref{chap:insights} therefore was to provide insights to aid in overcoming typical barriers to performance improvements of standard PV materials, such as detrimental defects and non-optimal device architectures, to accelerate the development of these solar cell devices to enable the investigation of possible novel PV effects in these materials. Investigating defect physics is still an on-going study. However, in section \ref{junctions} we provide suggestions for junction partners for two of the candidates identified in \autoref{chap:screening}.
