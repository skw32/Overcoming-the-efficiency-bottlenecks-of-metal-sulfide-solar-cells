...
\begin{figure}[h!]
  \centering
    ...
    \caption[Visualisation of minima in the potential energy landscape of a molecular system.]{Visualisation of minima in the potential energy landscape of a molecular system. Figure reproduced from Ref.~\citenum{PE_landscape_ref}, where it is available online.}
  \label{PE_landscape}
\end{figure}
