...
\begin{figure}[h!]
  \centering
    ...
    \caption{A charge-neutral defect interacting with periodic images of itself across periodic boundary conditions in 2D (a) and the longer-ranged Coulombic interactions of charged defects (b). Figure taken from reference \citenum{ase_defects} and adapted. ** MAKE OWN? - especially for benchmark write up and add charge to defect in (b)?**}
  \label{defect_PBCs}
\end{figure}
...
** Cross-ref Thomas Durrant's paper theory SII **
